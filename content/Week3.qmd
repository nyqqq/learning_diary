...
3. Irradiance: The amount of radiation from sun to the earth surface.
4. Path radiance: Radiance that is reflected above the surface.
5. Radiance: The amount of radiation from earth surface to the sensor.
6. Mosaicking: The process to merge two images.
7. Nadir: The direction pointing directly downwards from the sensor, with no angular deviation.
